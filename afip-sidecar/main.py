...
async def lifespan(app: FastAPI):
    ...
    """
    global afip_client, _rdb, _retry_task
    import asyncio
    ...
    # La conexión se guarda en _rdb (módulo-global) para ser reutilizada por
    # los clientes efímeros del modo stateless (F1-4).
    rdb = None
    try:
        ...
        rdb = None
    _rdb = rdb  # Expose to stateless per-request clients
